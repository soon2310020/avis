...
@AllArgsConstructor
@NoArgsConstructor
public class MbCallBackTransactionReqDto {
    @NotNull
...
//    @Pattern(regexp = "ACCOUNT|CARD")
    ...
    private String mbFundingAccount;
    ...
    @Schema(description = "Kiểu String. Mã FT của giao dịch MB")
    private String mbReferenceNumber;

    @JsonProperty(value = "way4DocsId")
    private String way4DocsId;

    @JsonProperty(value = "ftNumber")
    ...
    public String toString() {
        return "MbCallBackTransactionReqDto{" +
                "id='" + id + '\'' +
                ", merchant=" + merchant +
                ", cif='" + cif + '\'' +
                ", amount=" + amount +
                ...
                ", cardType='" + cardType + '\'' +
                ", checksum='" + checksum + '\'' +
                ", mbReferenceNumber='" + mbReferenceNumber + '\'' +
                ", way4DocsId='" + way4DocsId + '\'' +
                ", ftNumber='" + ftNumber + '\'' +
                '}';
    }
}