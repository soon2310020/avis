...
@NoArgsConstructor
@AllArgsConstructor
public class ResetPWMessage extends MailMessage {
  ...
  @Builder
  public ResetPWMessage(List<String> receivers, String title, String content, String host, User user, String token) {
...
/*
  ...
  public String getContent() {
    ...
    return "<!DOCTYPE html>\n" +
            ...
            "      <div>\n" +
            "        <p><b>Hi " + this.user.getName() + ",</b> <br> <br> You recently requested to reset the password for your eMoldino account. Click the button below to reset it.</p>\n" +
            "      </div>\n" +
...
*/
  ...
  public String getContent() {
    ...
    String hiRow = "        <p><b>Hi " + this.user.getName() + ",</b> <br> <br> You recently requested to reset the password for your eMoldino account. Click the button below to reset it.</p>\n";
