...
@NoArgsConstructor
@AllArgsConstructor
public class PwdExpireReminderMessage extends MailMessage {
    ...
    @Builder
    public PwdExpireReminderMessage(List<String> receivers, String title, String content, String host, User user, String token) {
    ...
    public String getTitle() {
        return "[eMoldino Support Team] Password Expiry Notification";
    }
...
/*
    ...
    public String getContent() {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "      <div>\n" +
                "        <p><b>Hi " + this.user.getName() + ",</b> <br> <br> Your password expires in 7 days. Please, click the button below to renew it.</p>\n" +
                "      </div>\n" +
                ...
                "          <a href=\" " + host + "/api/users/cpassword/" + this.token + "\" style=\"color: #fff !important; text-decoration: unset\">Change Password</a>\n" +
                "        </div>\n" +
                "      </div>\n" +
                "      <div>\n" +
                "        <p>This password reset is only valid for the next 30 minutes. <br><br> Thanks, <br>eMoldino Support Team</p>\n" +
                "      </div>\n" +
                "    </div>\n" +
                "  </div>\n" +
...
*/
    ...
    public String getContent() {
        ...
        String hiRow = "        <p><b>Hi " + this.user.getName() + ",</b> <br> <br> Your password expires in 7 days. Please, click the button below to renew it.</p>\n";
        String linkRow = "          <a href=\" " + host + "/api/users/cpassword/" + this.token + "\" style=\"color: #fff !important; text-decoration: unset\">Change Password</a>\n";
        String textR1 = "        <p>This password reset is only valid for the next 30 minutes. <br><br> Thanks, <br>eMoldino Support Team</p>\n";
        String linkR2 = "          <a href=\" " + host + "/support/customer-support/" + "\" style=\"color:#195bcd !important;\"> Support Center</a>\n";
        return LockAccountMessage.contentTemp(hiRow, linkRow, textR1, linkR2);
    }
