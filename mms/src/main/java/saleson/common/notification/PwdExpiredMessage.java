...
@NoArgsConstructor
@AllArgsConstructor
public class PwdExpiredMessage extends MailMessage {
    ...
    @Builder
    public PwdExpiredMessage(List<String> receivers, String title, String content, String host, User user, String token) {
    ...
    public String getTitle() {
        return "[eMoldino Support Team] Renew Your Password";
    }
/*
    ...
    public String getContent() {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "      <div>\n" +
                "        <p><b>Hi " + this.user.getName() + ",</b> <br> <br> Your password has been expired. Please, click the button below to renew it.</p>\n" +
                "      </div>\n" +
...
*/
    ...
    public String getContent() {
        ...
        String hiRow = "        <p><b>Hi " + this.user.getName() + ",</b> <br> <br> Your password has been expired. Please, click the button below to renew it.</p>\n";
        String linkRow = "          <a href=\" " + host + "/api/users/cpassword/" + this.token + "\" style=\"color: #fff !important; text-decoration: unset\">Reset My Password</a>\n";
