...
@Builder
public class MachineDowntimeAlert {
	@Id
	@GeneratedValue
	private Long id;
	...
	@JoinColumn(name = "machineId", insertable = false, updatable = false)
	...
	@JsonIgnore
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "reportedBy", insertable = false, updatable = false)
	private User reportedUser;

	private Long confirmedBy;
	@JsonIgnore
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "confirmedBy", insertable = false, updatable = false)
