...
var vm = new Vue({
    ...
    methods: {
        ...
        submitChecklist() {
            ...
            this.form.checklistType = 'REJECT_RATE';
        ...
        callbackMessageForm: function () {
            location.href = document.referrer.includes('checklist-center')
                ? document.referrer + '?systemNoteFunction=CHECKLIST_REJECT_RATE'
                : '/admin/checklist-center?systemNoteFunction=CHECKLIST_REJECT_RATE';
    ...
    mounted() {
        this.$nextTick(function () {
            vm.getResources();
            Page.ID = Common.$uri.pathname.replace('/admin/checklist-center/reject-rate/', '').replace('/edit', '');
            console.log(Page.ID, 'Page.IDPage.ID');
