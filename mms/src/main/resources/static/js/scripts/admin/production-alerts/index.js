...
window.onload = function () {
  document.title = "Production Alerts";
  setTimeout(() => {
...
var Page = Common.getPage("production-alerts");
var vm = new Vue({
  el: "#app",
  components: {
    "production-alert": httpVueLoader(
      "/components/alert-based-pages/production-alert/index.vue"
    ),
  },
});
