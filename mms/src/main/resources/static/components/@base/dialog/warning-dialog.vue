<template>
  <div
    ref="dialogRef"
    class="custom-dialog custom-dialog-warining dialog"
  ...
  >
    <div
      ...
      style="height: fit-content; border-radius: 3px"
      :class="[dialogClasses]"
    >
      <!-- MODAL BODY START -->
      <div
      ...
      >
        <div
          ...
          @click="handleClose"
        >
          <img src="/images/icon/common/close-icon.svg" alt="" />
        </div>
        <slot></slot>
      </div>
      <!-- MODAL BODY END -->
...
.custom-dialog.dialog .dialog-sm {
  max-width: 456px;
}
...
.custom-dialog-warining .dialog-body {
