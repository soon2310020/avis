<template>
  <div class="new-feature-content" id="tooling-tab-view">
    <div class="tooling-tab-view">
      <div class="bottom-content">
        <div class="triangle-arrow"></div>
        <div class="close-hint" @click="done">
        ...
        <div class="content-body">
          <div class="desc-item">
            Create, edit and delete tab view using the new feature - Tab View under the More menu.
          </div>
        </div>
  ...
  methods: {
    ...
    calculatePosition() {
      ...
      if (firstCheckboxOffset) {
        let element = document.getElementById("tooling-tab-view");
        element.style.margin = `${firstCheckboxOffset.y + 26}px ${firstCheckboxOffset.x - 365}px`;
        let position = {
    ...
    getFirstHintElementDocumentModel() {
      let hintElements = document.getElementsByClassName('customize-hint');
...
.tooling-tab-view .top-content {
  background-color: #FFF;
  display: inline-block;
  font-size: 15px;
}
.tooling-tab-view .bottom-content {
  background: #5a4ab9;
  color: #FFF;
  margin-top: 2.5rem;
