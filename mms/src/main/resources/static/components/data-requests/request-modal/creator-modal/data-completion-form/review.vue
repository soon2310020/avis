  ...
  <div class="step-content">
    ...
    <div class="d-flex align-center">
      ...
      <div class="form-item" style="margin-left: 40px">
        ...
        <div>
          <base-avatar v-for="(item, index) in selectedUsers" :key="index" :item="item" class="mr-2">
          </base-avatar>
        </div>
      </div>
    </div>
    <div class="form-item">
      ...
      <div class="d-flex align-center">
        <base-input style="width: 105px" :readonly="true" :value="getRequestDateTitle">
        </base-input>
        <base-input style="width: 65px; margin-left: 4px;" :readonly="true" :value="requestTimeDisplay">
        </base-input>
      </div>
    </div>
    <div class="form-item">
      ...
      <div class="d-flex align-center">
        <base-input style="width: 105px" :readonly="true" :value="getDueDateTitle">
        </base-input>
        <base-input style="width: 65px; margin-left: 4px;" :readonly="true" :value="dueTimeDisplay">
        </base-input>
      </div>
    </div>
    <div class="form-item">
    ...
    <div class="form-item align-top">
      ...
      <div>
        <textarea v-model="request.detail" cols="100" rows="7" readonly class="custom-text-area"
          style="width: 100%; resize: none" :placeholder="resources['enter_detail_s']"></textarea>
      </div>
    </div>
    <div class="form-item align-top">
      <label style="margin-top: 8px">{{ resources["attachments"] }}:</label>
      <div>
        <preview-images-system :is-viewing="false" :images="request.attachment"
          :images-uploaded="request.uploadedAttachment" @delete-img="handleDeleteAttachment"
          @delete-uploaded-img="handleDeleteUploadedAttachment"></preview-images-system>
      </div>
    </div>
  </div>
</template>
