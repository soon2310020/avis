          ...
          <ul class="nav nav-tabs" style="margin-bottom: -1px">
            ...
            <!-- <li class="nav-item">
              <a class="nav-link" :class="{active: requestParam.companyType === 'IN_HOUSE'}" href="#"
                 @click.prevent="tab('IN_HOUSE')"><span v-text="resources['in_house']"></span>
                <span class="badge badge-light badge-pill"
            ...
            <li class="nav-item">
              <a class="nav-link" :class="{active: requestParam.companyType === 'SUPPLIER'}" href="#"
                 @click.prevent="tab('SUPPLIER')"><span v-text="resources['supplier']"></span>
                <span class="badge badge-light badge-pill"
            ...
            <div class="nav-item" style="position: absolute;right: 62px;">
                          <!-- <a @click="goToNew" id="goToNew" href="javascript:void(0)" class="btn-custom btn-custom-primary">
                           ...
                           <a href="javascript:void(0)" class="btn-custom btn-custom-primary">
                            <span v-text="resources['create_codelist']"></span>
                          </a>
                        </div>
...
module.exports = {
  ...
  methods: {
    ...
    goToEdit () {
      ...
      window.location.href = `/admin/checklist-center/reject-rate/${this.listChecked[0]}/edit`
    },
    ...
    setAllColumnList() {
      this.allColumnList = [
        ...
        { label: this.resources['code_title'], field: 'codeTitle', default: true, mandatory: true, sortable: true, defaultSelected: true, defaultPosition: 0},
        { label: this.resources['code_id'], field: 'codeId', default: true, sortable: true , sortField: 'group1Code', defaultSelected: true, defaultPosition: 1},
        { label: this.resources['company'], field: 'company', default: true, sortable: true, defaultSelected: true, defaultPosition: 2},
        { label: this.resources['main_level'], field: 'mainLevel', default: true, sortable: true, sortField: 'code', defaultSelected: true, defaultPosition: 3},
        { label: this.resources['sub_level'], field: 'subLevel', default: true, sortable: true, defaultSelected: true, defaultPosition: 4},
         { label: this.resources['description'], field: 'description', default: true, sortable: true, defaultSelected: true, defaultPosition: 5},
    ...
    saveBatch (user, boolean) {
      ...
      let self=this;
      axios.post('/api/checklist/change-status-in-batch', param).then(function (response) {
        self.paging(1);
      }).catch(function (error) {
        console.log(error.response);
      }).finally(() => {
    ...
    save: function (checklist) {
      ...
      let self=this;
      axios.put('/api/checklist' + '/' + checklist.id + '/enable', param).then(function (response) {
        self.paging(1);
      }).catch(function (error) {
        console.log(error.response);
      }).finally(() => {
    ...
    paging: function (pageNumber) {
      ...
      axios.get('/api/common/cod-viw/code-types/MACHINE_DOWNTIME_REASON_GROUP1/data' + '?' + param, {
