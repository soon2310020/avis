<template>
    <div>
          ...
          <div class="card-header-actions">
                    ...
                    <div class="card-footer" style="display: none">
                        <button class="btn btn-sm btn-primary" type="submit">
                            <i class="fa fa-dot-circle-o"></i> <span v-text="resources['submit']"></span>
                        </button>
                        <button class="btn btn-sm btn-danger" type="reset">
                            <i class="fa fa-ban"></i> <span v-text="resources['reset']"></span>
                        </button>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="nav nav-tabs" style="margin-bottom: -1px">
                            <li class="nav-item">
                                <a
                                    ...
                                    <span class="badge badge-light badge-pill" v-if="requestParam.companyType === 'all'">{{ total }}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a
                            ...
                            <thead id="thead-actionbar" class="custom-header-table">
                                <tr :class="{ invisible: listChecked.length != 0 }" style="height: 57px" class="tr-sort">
                                    ...
                                    <th
                                        ...
                                        :key="index"
                                        :class="[
                                            { __sort: item.sortable, active: currentSortType === item.sortField },
                                            isDesc ? 'desc' : 'asc',
        ...
        <codelist-form @parentmethod="getUpdatedData" :resources="resources"></codelist-form>
...
module.exports = {
    components: {
        'codelist-form': httpVueLoader('./codelist-form.vue'),
    },
    props: {
        resources: Object,
    },
    ...
    methods: {
        ...
        getAllData() {
            return axios
                .get('/api/common/cod-viw/code-types/MACHINE_DOWNTIME_REASON/data' + '?' + Common.param(this.requestParam))
        ...
        goToNew() {
            var child = Common.vue.getChild(this.$children, 'codelist-form');
            if (child != null) {
        ...
        setAllColumnList() {
            this.allColumnList = [
                ...
                {
                    label: this.resources['code_title'],
                    field: 'codeTitle',
                    default: true,
                    mandatory: true,
                    sortField: 'title',
                ...
                },
                {
                    ...
                    default: true,
                    sortable: true,
                    sortField: 'group1Code',
                    defaultSelected: true,
                    defaultPosition: 2,
                },
                {
                    label: this.resources['main_level'],
                    field: 'mainLevel',
                    default: true,
                    sortable: true,
                    sortField: 'group1Code',
                ...
                {
                    label: this.resources['sub_level'],
                    field: 'subLevel',
                    default: true,
                    sortable: true,
                    sortField: 'group2Code',
                    defaultSelected: true,
                    defaultPosition: 4,
                },
                {
        ...
        saveBatch(user, value) {
            ...
            let self = this;
            axios
                .put('/api/common/cod-stp' + '/' + value + '?id=' + idArr.toString())
                .then(function (response) {
                    self.paging(1);
        ...
        save: function (codelist, value) {
            ...
            let self = this;
            axios
                .put('/api/common/cod-stp' + '/' + value + '?id=' + codelist.id)
                .then(function (response) {
                    console.log(response);
                    self.paging(1);
                })
        ...
        paging: function (pageNumber) {
            ...
            axios
                .get('/api/common/cod-viw/code-types/MACHINE_DOWNTIME_REASON/data' + '?' + param, {
