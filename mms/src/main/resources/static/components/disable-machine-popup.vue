      ...
      <div style="box-shadow: 0 0 3px #00000029" class="modal-content">
        <div class="modal-body">
          ...
          <div class="custom-modal-warning card-body-custom">
            ...
            <!--            <input v-model="isChecked" id="checkbox-all" class="checkbox" type="checkbox" />-->
          ...
          <div class="custom-modal-confirm-zone">
            <div>
              <div @click="onCloseModal">No. Don’t Disable.</div>
            </div>
            <div>
              ...
              >
                <span> Yes, Move to Disabled </span>
              </a>
...
<script>
module.exports = {
  name: "disable-machine-popup.vue",
  props: {
    resources: Object,
    list: Array,
