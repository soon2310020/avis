...
module.exports = {
  ...
  data() {
    return {
      ...
      requestParam: {
        ...
        page: 1,
        id: "",
        checklistType: "QUALITY_ASSURANCE",
      },
      currentSortType: "id",
      isDesc: true,
      pageType: "CHECKLIST_QUALITY_ASSURANCE",
      allColumnList: [],
      showDropdown: false,
      listChecked: [],
      listCheckedTracked: {},
  ...
  methods: {
    ...
    goToNew() {
      ...
      setTimeout(() => {
        el.classList.remove("primary-animation");
        window.location.href = "/admin/checklist-center/quatity_assurance/new";
      }, 700);
    },
    closeShowDropDown() {
