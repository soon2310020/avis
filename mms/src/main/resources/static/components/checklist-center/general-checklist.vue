            ...
            <table class="table table-responsive-sm table-striped">
              <thead id="thead-actionbar" class="custom-header-table">
                ...
                >
                  ...
                  <th
                    v-for="(item, index) in allColumnListEnabled"
                    :key="index"
                    :class="[
                      {
              ...
              <tbody class="op-list" style="display: none">
                ...
                >
                  ...
                  <template
                    v-for="(column, columnIndex) in allColumnListEnabled"
                  >
                    <td
...
module.exports = {
  ...
  computed: {
    allColumnListEnabled() {
      return this.allColumnList.filter((i) => i.enabled);
    },
  },
  created() {},
  mounted() {
  ...
  methods: {
    ...
    goToNew() {
      ...
      setTimeout(() => {
        el.classList.remove("primary-animation");
        window.location.href = "/admin/checklist-center/general/new";
      }, 700);
    },
    closeShowDropDown() {
    ...
    goToEdit() {
      ...
      // window.location.href = `/admin/checklist-center/general/${this.listChecked[0]}/edit`
    },
