...
public interface IApi3rdMethods {
    <B> B post(IFunction func, HttpHeaders headers, Object payload, Class<B> responseType, @Nullable Map<String, ?> uriVariables) throws Exception;
    ...
    /***/
    default <B> B post(IFunction func, HttpHeaders headers, Object payload, Class<B> responseType) throws Exception {
        return post(func, headers, payload, responseType, null);
    }
