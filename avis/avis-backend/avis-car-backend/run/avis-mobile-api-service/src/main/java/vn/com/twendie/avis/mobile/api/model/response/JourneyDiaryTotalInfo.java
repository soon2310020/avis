...
@Data
@Builder
public class JourneyDiaryTotalInfo {
    ...
    @JsonProperty("total_journey_diary_costs")
    private List<TotalJourneyDiaryCost> totalJourneyDiaryCosts;

    @JsonProperty("journey_diary_station_fees")
    private List<JourneyDiaryStationFeeDTO> journeyDiaryStationFees;
