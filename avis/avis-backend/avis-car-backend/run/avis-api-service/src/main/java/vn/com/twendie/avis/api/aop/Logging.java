...
public class Logging {
    ...
    @Pointcut("within(vn.com.twendie.avis.api.controller.*)")
    public void withinControllers() {
    }

    @Pointcut("within(vn.com.twendie.avis.api.service.impl.*)")
    public void withinServiceImpls() {
    }

    @Pointcut("within(vn.com.twendie.avis.api.repository.*)")
    ...
    @Pointcut("!@annotation(vn.com.twendie.avis.api.aop.Logging.NoLogging)")
